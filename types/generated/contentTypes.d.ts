...
export interface ApiDislikedMovieDislikedMovie
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Actors: Schema.Attribute.String;
    IMDBRating: Schema.Attribute.String;
    RottenTomatoesRating: Schema.Attribute.Integer;
...
export interface ApiLikedMovieLikedMovie extends Struct.CollectionTypeSchema {
...
export interface ApiSeenMovieSeenMovie extends Struct.CollectionTypeSchema {
